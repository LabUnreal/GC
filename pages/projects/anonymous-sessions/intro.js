...
export default function IntroPage() {
    ...
    return (
        ...
        >
            ...
            <Heading size="md" pl="2rem" pt="2rem" fontWeight={200}> By {session.author}</Heading>
